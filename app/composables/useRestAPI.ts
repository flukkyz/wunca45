export const useRestAPI = <DataT>(endpoint: string) => {
  ...
  const destroy = (id: number) => {
    return useIFetch(`${endpoint}/${id}`, { method: "DELETE", watch: false });
  };
